...
import com.boryans.tefter.utils.Constants.NEGATIVE_NUMBER
import com.boryans.tefter.utils.Constants.POSITIVE_NUMBER
...
class Payments : Fragment(R.layout.fragment_payments), DebtorOnClickListener {
    ...
    override fun onDebtorClick(debtorId: Int) {
        Navigation.findNavController(requireView()).navigate(PaymentsDirections.actionPaymentsToDebtorDetail(debtorId))
    }
}