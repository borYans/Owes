...
import com.boryans.tefter.utils.Constants
...
class EditDebtor : Fragment(R.layout.fragment_edit_debtor_detail) {
    ...
    private fun notValidEntry() = nameInputBoxEdit.text.isNullOrEmpty() || amountInputBoxEdit.text.isNullOrEmpty() || referenceInputBoxEdit.text.isNullOrEmpty() || dueDateButtonEdit.text.isNullOrEmpty()
